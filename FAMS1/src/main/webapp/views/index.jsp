		...
		<div class="dINCO">
			<div class="dINLE">
				<div class="dMECO">
					...
					<div class="dMELI2">
						<a href="" id="clazz_list"><span>&#8594;</span> Clazz
							Information</a>
					</div>
					<div class="dMELI2">
					...
					<div class="dMELI2">
						<a href="#" onclick="loadOrder();"><span>&#8594;</span>
							Trainee Pool</a>
					</div>
					<div class="dMELI2">
					...
					<div class="dMELI2">
						<a href="#" id="course_list"><span>&#8594;</span>Course List</a>
					</div>
					<div class="dMELI2">
					<!-- id="course_add" -->
						<a href="#" id="course_add"><span>&#8594;</span> Add Course</a>
					</div>
